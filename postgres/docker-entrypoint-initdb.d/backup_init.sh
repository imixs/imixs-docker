...
if [ "$BACKUP_ROOT_DIR" != "" ]
  then
     ...
     echo "Backup root dir not specified, using the default /imixs-cloud..."
     export BACKUP_ROOT_DIR="/imixs-cloud"
fi
...
echo "TBD: cron can not be started - need to be fixed"
