...
BACKUP_VOLUME_DATA="$(ls -lah $BACKUP_VOLUME)"
# ****************************************************
...
nc $EXIM_SMARTHOST_NAME 25 -i 2 > /dev/null << NCEOF
...
- Backed-up $BACKUP_DB_TYPE database: $BACKUP_DB
- Backed-up volume: $BACKUP_VOLUME
- Backed-up volume data: $BACKUP_VOLUME_DATA
